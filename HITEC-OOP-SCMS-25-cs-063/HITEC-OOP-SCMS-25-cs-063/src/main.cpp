    ...
    do {
        ...
        switch (choice) {
            ...
            case 2: {
                ...
                faculties[facultyCount] = new Faculty(name, cnic, age, contact, empID, dept, designation);
            ...
            case 3: {
                ...
                cout << "Enter Max Capacity: "; cin >> maxcap; cin.ignore();
            ...
            case 4: {
                ...
                cout << "Enter Publication Year: "; cin >> year; cin.ignore();
            ...
            case 5: {
                ...
                cout << "Enter Student Reference: "; getline(cin, ref);
                cout << "Enter Semester Fee: ";      cin >> semFee;
                cout << "Enter Hostel Fee: ";        cin >> hostFee;
                cout << "Enter Library Fine: ";      cin >> fine; cin.ignore();
            ...
            case 6: {
                string blockName;
                cout << "Enter Block Name: "; getline(cin, blockName);
                HostelBlock block(blockName);
                for (int i = 0; i < 3; i++) {
                    int roomNo, floor;
                    string type;
                    cout << "\nRoom " << i + 1 << endl;
                    cout << "Room Number: ";             cin >> roomNo; cin.ignore();
                    cout << "Type (Single/Double/Triple): "; getline(cin, type);
            ...
            case 8: {
                string searchRoll;
                cout << "Enter Roll Number: "; getline(cin, searchRoll);
                bool found = false;
            ...
            case 9: {
                string roll;
                cout << "Enter Roll Number To Delete: "; getline(cin, roll);
                bool found = false;
                for (int i = 0; i < studentCount; i++) {
